...
int zmk_widget_wpm_status_init(struct zmk_widget_wpm_status *widget, lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_color(widget->wpm_value, lv_color_hex(THEME_COLOR_FG), 0);
    ...
    lv_obj_set_style_text_color(widget->wpm_icon, lv_color_hex(THEME_COLOR_FG_MID), 0);
