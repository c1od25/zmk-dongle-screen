 ...
 *
 * Fades in (1.5s) while the keyboard is asleep — 30s without a key press
 ...
 * over. Drives a small RGB565 canvas at 20fps from a fixed 60-frame drop
 * schedule (frame 60 == frame 0, seamless loop). */
