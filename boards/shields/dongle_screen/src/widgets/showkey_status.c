...
static const struct key_name {
    ...
    {0x2D, "MINUS"}, {0x2E, "="},     {0x2F, "["},     {0x30, "]"},     {0x31, "\\"},
    {0x33, ";"},     {0x34, "'"},     {0x35, "`"},     {0x36, ","},     {0x37, "."},
    {0x38, "/"},     {0x46, "PRTSC"}, {0x47, "SCRLK"}, {0x48, "PAUSE"}, {0x49, "INS"},
    {0x4A, "HOME"},  {0x4B, "PGUP"},  {0x4C, "DEL"},   {0x4D, "END"},   {0x4E, "PGDN"},
    {0x53, "NUMLK"}, {0x54, "KP/"},   {0x55, "KP*"},   {0x56, "KP-"},   {0x57, "KP+"},
    {0x58, "KPENT"}, {0x59, "KP1"},   {0x5A, "KP2"},   {0x5B, "KP3"},   {0x5C, "KP4"},
...
static void showkey_align(struct zmk_widget_showkey_status *widget, struct showkey_lookup *r) {
    if (r->kind == SHOWKEY_SIDE_ICON) {
        ...
        lv_coord_t side_w = lv_text_get_width(
            side, (uint32_t)strlen(side), lv_obj_get_style_text_font(widget->label, LV_PART_MAIN),
...
static void showkey_apply(struct zmk_widget_showkey_status *widget, struct showkey_lookup *r) {
    if (r->kind == SHOWKEY_TEXT) {
        ...
        lv_obj_set_style_text_font(widget->icon_label,
                                   r->font != NULL ? r->font : &NerdFonts_Regular_48, LV_PART_MAIN);
    }
...
static void showkey_status_update_cb(struct showkey_status_state state) {
    ...
    bool shift_held = (zmk_hid_get_keyboard_report()->body.modifiers & (MOD_LSFT | MOD_RSFT)) != 0;
    ...
    bool caps_lock = (zmk_hid_indicators_get_current_profile() & HID_INDICATOR_CAPS_LOCK) != 0;
