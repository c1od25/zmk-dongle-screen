...
LV_FONT_DECLARE(NerdFonts_Regular_48);
LV_FONT_DECLARE(NerdFonts_Speedo_40);
LV_FONT_DECLARE(Mono_48);
LV_FONT_DECLARE(Mono_28);
LV_FONT_DECLARE(Mono_20);
LV_FONT_DECLARE(Mono_Italic_48);
LV_FONT_DECLARE(Mono_Italic_20);
LV_FONT_DECLARE(Gripper_20);
LV_FONT_DECLARE(Volume_48);
